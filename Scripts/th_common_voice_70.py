...
_LANGUAGES = {
    "th": {
        ...
        "Date": "2022-09-21",
        "Size": "7.69 GB",
        "Version": "th_255h_2022-09-21",
        "Validated_Hr_Total": 158,
        "Overall_Hr_Total": 395,
        "Number_Of_Voice": 7678,
    },
}
...
class CommonVoice(datasets.GeneratorBasedBuilder):
    ...
    def _info(self):
        ...
        return datasets.DatasetInfo(
            ...
            citation=_CITATION,
            # task_templates=[
            #     AutomaticSpeechRecognition(audio_column="path", transcription_column="sentence")
            # ],
        )

    def _split_generators(self, dl_manager):
        """Returns SplitGenerators."""
        abs_path_to_data = os.path.join("D:\\UT\\DataSet", self.config.name)
